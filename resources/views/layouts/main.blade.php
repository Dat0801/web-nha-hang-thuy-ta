...
<body>
            ...
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav d-flex gap-5 mx-auto">
                        <li class="nav-item">
                            <a class="nav-link fw-bold" href="#">Thực đơn</a>
                        </li>
    ...
    <footer class="footer text-white py-4" style="background-image: url('{{ asset('images/bg-footer.png') }}');">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3 me-3">
                    ...
                    <p><i class="bi bi-geo-alt"></i>  03 Hòa Bình, Phường 3, Quận 11, TP.Hồ Chí Minh (Cổng số 2 Công viên Văn hóa Đầm Sen)</p>
                    <p><i class="bi bi-telephone"></i>  028 3961 2082 - 028 3858 6763</p>
                </div>
    
                <div class="col-md-4 mb-3">
                    <h4 class="font-weight-bold text-wrap" style="margin-left: 14px">Các đơn vị cùng hệ thống Phuthotourist</h4>
                    <ul class="inline">
                        <li><a href="#" class="text-white">Công ty A</a></li>
                        <li><a href="#" class="text-white">Công ty B</a></li>
                        <li><a href="#" class="text-white">Công ty C</a></li>
                    </ul>
                </div>
            </div>
